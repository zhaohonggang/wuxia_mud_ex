defmodule Kantele.Combat.Skills.MingwangJian do
  @moduledoc """
  明王剑法（对照 `kungfu/skill/mingwang-jian.c`）

  剑法载体：`valid_enable("sword")` / `valid_enable("parry")`。

  绝招实现见 `lib/kantele/combat/skills/performs/mingwang_jian/`。
