defmodule Kantele.Combat.Skills.Performs.ChanhunSuo.Duo do
  @moduledoc """
  夺魂势「duo」（对照 `kungfu/skill/chanhun-suo/duo.c`）

  缠魂锁法攻击绝招：消耗 220 内力，发起 `combat/perform-incoming` 事件。

  差异（TODO(migrate)）：
  - LPC 仅 `level:chanhun-suo>=100,force>=130`；本版加 `mapped` 与 `neili` 门槛；
