defmodule Kantele.Combat.Skills.Performs.QiankunJian.Qian do
  @moduledoc """
  乾坤劲「qian」（对照 `kungfu/skill/qiankun-jian/qian.c`）

  乾坤剑法单体攻击：消耗 300 内力，对战斗中对手出招。

  差异（TODO(migrate)）：
  - LPC 仅 `level:qiankun-jian>=100,force>=150`；本版加 `mapped` 与 `neili` 门槛；
