defmodule Kantele.Combat.Skills.Performs.BaguaDao.Sha do
  @moduledoc """
  杀龙无悔「sha」（对照 `kungfu/skill/bagua-dao/sha.c`）

  八卦刀法攻击绝招：消耗 300 内力，发起 `combat/perform-incoming` 事件，
  由目标侧 `resolve_incoming` 判定命中并施加伤害。

  差异（TODO(migrate)）：
  - LPC 仅 `level:bagua-dao>=180,force>=250`；本版加 `mapped` 与 `neili` 门槛；
