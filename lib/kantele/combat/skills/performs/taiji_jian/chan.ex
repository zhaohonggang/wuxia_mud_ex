defmodule Kantele.Combat.Skills.Performs.TaijiJian.Chan do
  @moduledoc """
  缠字诀「chan」（对照 `kungfu/skill/taiji-jian/chan.c`）

  太极剑法单体攻击：消耗 60 内力，对战斗中对手出招。

  差异（TODO(migrate)）：
  - LPC 仅 `level:taiji-jian>=80`；本版加 `mapped` 与 `neili` 门槛；
