defmodule Kantele.Combat.Skills.Performs.QuanzhenJian.Chan do
  @moduledoc """
  缠字诀「chan」（对照 `kungfu/skill/quanzhen-jian/chan.c`）

  全真剑法单体攻击：消耗 100 内力，对战斗中对手出招。

  差异（TODO(migrate)）：
  - LPC 仅 `level:quanzhen-jian>=80`；本版加 `mapped` 与 `neili` 门槛；
