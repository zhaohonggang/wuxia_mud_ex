defmodule Kantele.Combat.Skills.DongyangDao do
  @moduledoc """
  东洋刀法（对照 `kungfu/skill/dongyang-dao.c`）

  刀法载体：`valid_enable("blade")` / `valid_enable("parry")`。

  绝招实现见 `lib/kantele/combat/skills/performs/dongyang_dao/`。
