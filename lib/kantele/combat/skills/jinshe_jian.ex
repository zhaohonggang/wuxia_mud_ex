defmodule Kantele.Combat.Skills.JinsheJian do
  @moduledoc """
  金蛇剑法（对照 `kungfu/skill/jinshe-jian.c`）

  剑法载体：`valid_enable("sword")` / `valid_enable("parry")`。

  绝招实现见 `lib/kantele/combat/skills/performs/jinshe_jian/`。
