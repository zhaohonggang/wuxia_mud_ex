defmodule Kantele.Sects do
  ...
  @sects %{
    ...
    "yaowang" => %{
      ...
      maps: %{
        "force" => "shennong-xinjing",
        "dodge" => "xuefu-mizong",
        "strike" => "dusha-zhang",
        "hand" => "lansha-shou",
        "throwing" => "wuxing-jueming",
        "parry" => "shennong-zhang",
        "staff" => "shennong-zhang",
        "poison" => "dispel-poison",
        "medical" => "yaowang-miaoshu"
      },
    ...
    "wudu" => %{
      ...
      maps: %{
        ...
        "dodge" => "jinshe-youshenbu",
        "strike" => "tianchan-zhang",
        "claw" => "wusheng-zhao",
        "parry" => "ruanhong-zhusuo",
