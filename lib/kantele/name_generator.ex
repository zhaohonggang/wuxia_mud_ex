defmodule Kantele.NameGenerator do
  @moduledoc """
  中文姓名生成器（对应 lpc_example/class_npc/chinese.c 的 NPC_D 守护进程）
  ...
  @male_given %{
    ...
    "gao" => "高皋郜镐", "hong" => "洪红宏鸿泓弘", "hu" => "虎忽湖护乎祜浒怙",
    "hua" => "化华骅桦", "hao" => "号浩皓蒿浩昊灏淏", "ji" => "积极济技击疾及基集记纪季继吉计冀祭际籍绩忌寂霁稷玑蓟戢佶奇诘笈畿",
    ...
    "zhi" => "制至值质致智志直治执止置芝旨峙芷挚郅炙雉帜", "zhong" => "中忠钟衷",
    "zhou" => "周州舟胄繇昼", "zhu" => "竹主驻朱祝诸著竺",
    "zhuo" => "卓灼灼拙琢斫斟", "zi" => "子资兹孜梓", "zong" => "宗枞",
    "zu" => "足族祖卒", "zuo" => "作左佐笮凿"
  }
  ...
  def random_name(gender, rng \\ &:rand.uniform/1) do
    ...
    {id2, pname_char2} =
      if rng.(3) == 1 do
        pname2 = pick_distinct(Map.keys(given), [id1 | [pname]], rng)
