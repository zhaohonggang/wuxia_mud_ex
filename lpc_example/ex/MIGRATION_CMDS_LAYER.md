...
> 分支: `kalevala` ｜ 更新: 2026-09-02 ｜ 总命令数: ~295
>
> **测试基线**: 1411 tests / 0 failures (2026-09-02)
>
> **注意**: 以下详细表格基于早期状态（872 tests），最新进度见 `MIGRATION_PLAN.md` 的勾选表。W1-W3 (巫师权限) 和 K1-K3 (技能命令) 已完成。
