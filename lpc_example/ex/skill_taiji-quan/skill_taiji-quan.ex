defmodule ExKantele.Combat.Skills.TaijiQuan do
  @moduledoc """
  对应原文件: lpc_example/skill/skill_taiji-quan.c (太极拳, 15003B)

  迁移判定: B/C —— 主体(招式表+select)单文件可落，但部分回调缺底层：
    B 可落: @actions 招式表、pick_action(query_action)、valid_learn、practice_cost
    C 需底层: valid_combine / valid_damage / query_effect_parry / hit_ob ——
              现有 Kantele.Combat.Skill 行为里都没有，需扩展到战斗引擎。
  """
  ...
  # 招式表: action/force/dodge/parry/skill_name/lvl/damage_type，与 LPC 一致
  @actions [
