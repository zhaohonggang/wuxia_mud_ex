...
defmodule CombatE2E.Driver do
  def run() do
    ...
    # 同时删除测试角色的持久化档案，避免多轮运行后技能/潜能累积污染断言。
    cleanup_code = """
  ...
  defp scenario_code() do
    ...
    defmodule CombatE2E.Scenario do
      ...
      def run(_report) do
        ...
        |> settle(1200)
        |> expect_seen("learn-force", "基本内功", 8000)
      ...
      defp expect_seen(%{last_mark: mark} = state, label, text, timeout \\ 2000) do
