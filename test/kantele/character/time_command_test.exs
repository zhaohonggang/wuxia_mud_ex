defmodule Kantele.Character.TimeCommandTest do
  use ExUnit.Case, async: true

  import Kalevala.ConnTest

  alias Kantele.Character.TimeCommand
  ...
  describe "time 命令" do
    test "显示北京时间" do
      p = player()
      conn = TimeCommand.run(build_conn(p), %{})
    ...
    test "路由解析" do
      {:ok, parsed} = Kantele.Character.Commands.parse("time")
      assert parsed.module == TimeCommand
    end
  end
end
