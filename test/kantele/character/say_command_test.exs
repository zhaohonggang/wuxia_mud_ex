defmodule Kantele.Character.SayCommandTest do
  use ExUnit.Case, async: true

  import Kalevala.ConnTest

  alias Kantele.Character.SayCommand
  ...
  describe "say 命令" do
    ...
    test "路由解析" do
      {:ok, parsed} = Kantele.Character.Commands.parse("say hello")
      assert parsed.module == SayCommand
    end
  end
end
