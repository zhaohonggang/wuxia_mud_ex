defmodule Kantele.Character.ScoreCommandTest do
  use ExUnit.Case, async: true

  import Kalevala.ConnTest

  alias Kantele.Character.PlayerMeta
  alias Kantele.Character.ScoreCommand
  ...
  describe "score 命令" do
    test "展示角色状态" do
      p = player(combat_exp: 1000, potential: 500)
      conn = ScoreCommand.run(build_conn(p), %{})
    ...
    test "路由解析" do
      {:ok, parsed} = Kantele.Character.Commands.parse("score")
      assert parsed.module == ScoreCommand
    end
  end
end